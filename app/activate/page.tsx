...
export default function ActivatePage() {
  ...
  return <main dir="rtl" style={{minHeight:"100vh",display:"grid",placeItems:"center",background:"#f5f7f9",fontFamily:"Arial",color:"#0b1f33",padding:20}}>
    <section style={{width:"100%",maxWidth:460,background:"white",border:"1px solid #e2e7eb",borderRadius:18,padding:32,boxShadow:"0 14px 40px rgba(11,31,51,.08)"}}>
      ...
      <div style={{color:"var(--cgp-teal)",fontWeight:800,marginTop:7}}>تفعيل / استعادة حساب CGP</div>
      ...
      <form onSubmit={submit}>
        ...
        <button disabled={!ready||saving} style={{width:"100%",marginTop:24,border:0,borderRadius:10,padding:13,background:ready?"var(--cgp-teal)":"#9aa7ad",color:"white",fontWeight:800,fontSize:15,cursor:ready?"pointer":"not-allowed"}}>{saving?"جاري الحفظ...":"تعيين كلمة المرور"}</button>
      </form>
