...
function Kpi({label,value}:{label:string;value:string|number}){return <div style={kpi}><div style={{fontSize:13,color:"#586875",marginBottom:8}}>{label}</div><div style={{fontSize:30,fontWeight:800,color:"#0f7d73"}}>{value}</div></div>}
