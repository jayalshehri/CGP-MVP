...
export default function ControlDetailsPage() {
 ...
 useEffect(()=>{let active=true;(async()=>{try{
  ...
  if(active){setControl(c.data);setAuditFrequency(c.data.audit_frequency||'annual');setNextAuditDate(c.data.next_audit_date||'');setLastAuditDate(c.data.last_audit_date||'');setEvidence(e.data??[]);}
