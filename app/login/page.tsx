        ...
        <div style={{width:"100%",maxWidth:"440px"}}>
          <div style={{background:"white",border:"1px solid #e1e7ea",borderRadius:"20px",boxShadow:"0 18px 60px rgba(11,31,51,0.08)",padding:"38px"}}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" disabled={loading} style={{width:"100%",border:0,borderRadius:"10px",background:loading?"#789c98":"#0f756d",color:"white",padding:"14px 18px",marginTop:"24px",fontSize:"15px",fontWeight:800,cursor:loading?"not-allowed":"pointer"}}>{loading?"جاري تسجيل الدخول...":"دخول إلى CGP"}</button>
            </form>
          </div>
