...
export type UserRole = 'admin' | 'cybersecurity_team' | 'data_governance_team' | 'control_owner' | 'nca_external_auditor';
...
const validRoles: UserRole[] = ['admin', 'cybersecurity_team', 'data_governance_team', 'control_owner', 'nca_external_auditor'];
