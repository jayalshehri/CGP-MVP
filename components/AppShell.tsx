...
const navigation = [
  ...
  { href: "/roadmap/dashboard", label: "خارطة الطريق", group: "العمليات", team: true },
  { href: "/roadmap/analysis", label: "تحليل المحفظة", group: "العمليات", team: true },
  { href: "/roadmap", label: "سجل المشاريع", group: "العمليات", team: true },
